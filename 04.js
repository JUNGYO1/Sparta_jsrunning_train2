...
//4 이상은 4도 포함이기에 다 출력됩니다 kiwi나 lime같은 것들..
// 만약 4 초과라면 '>' 비교연산자 를 사용하면 되겠죱?
...
console.log(arr.filter((x) => x.length % 2 !== 0));
...
console.log(student.some((x) => x.name === null));
...
console.log(arr.some((x) => x.length > 5));
